...
public enum LocalizationKey
{
    ...
    menu_params_large_file_threshold,
    menu_manage_jobs,
    menu_job_details,
    menu_job_actions,
    menu_job_run,
    ...
    settings_large_file_threshold_active,
    settings_large_file_threshold_disabled,
    ...
    gui_config_large_file_threshold,
    gui_config_large_file_threshold_value_watermark,
    gui_config_large_file_threshold_invalid,
    size_unit_kilo,
    size_unit_mega,
    size_unit_giga,
    ...
    gui_progress_select_all,
    gui_progress_pause_selected,
    gui_progress_play_selected,
    gui_progress_stop_selected,
    gui_progress_confirm_stop_selected_message,
    ...
    gui_log_weekday_sat,
    gui_log_weekday_sun,
    gui_log_month_january,
    gui_log_month_february,
    gui_log_month_march,
    gui_log_month_april,
    gui_log_month_may,
    gui_log_month_june,
    gui_log_month_july,
    gui_log_month_august,
    gui_log_month_september,
    gui_log_month_october,
    gui_log_month_november,
    gui_log_month_december,
    gui_log_month_short_january,
    gui_log_month_short_february,
    gui_log_month_short_march,
    gui_log_month_short_april,
    gui_log_month_short_may,
    gui_log_month_short_june,
    gui_log_month_short_july,
    gui_log_month_short_august,
    gui_log_month_short_september,
    gui_log_month_short_october,
    gui_log_month_short_november,
    gui_log_month_short_december,
    gui_log_page_suffix,
    gui_log_status_in_progress,
    gui_log_status_paused,
    gui_log_status_blocked,
    gui_log_status_completed,
    gui_log_status_error,
    gui_log_status_stopped,
    gui_log_empty_title,
    gui_log_empty_subtitle,
    gui_log_event_create_directory,
    gui_log_event_transfer_file,
    gui_log_event_error,
    gui_log_event_start_backup,
